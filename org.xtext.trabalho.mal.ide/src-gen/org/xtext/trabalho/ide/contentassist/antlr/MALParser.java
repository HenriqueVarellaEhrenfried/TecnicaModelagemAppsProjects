		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getModuleStmtAccess().getAlternatives_0_0(), "rule__ModuleStmt__Alternatives_0_0");
					put(grammarAccess.getModuleStmtAccess().getAlternatives_1_0(), "rule__ModuleStmt__Alternatives_1_0");
					put(grammarAccess.getIncludeStmtAccess().getAlternatives(), "rule__IncludeStmt__Alternatives");
					put(grammarAccess.getIncludeStmtAccess().getAlternatives_0_0(), "rule__IncludeStmt__Alternatives_0_0");
					put(grammarAccess.getIncludeStmtAccess().getAlternatives_1_0(), "rule__IncludeStmt__Alternatives_1_0");
					put(grammarAccess.getDefinitionAccess().getAlternatives(), "rule__Definition__Alternatives");
					put(grammarAccess.getDefinitionAccess().getAlternatives_0_0(), "rule__Definition__Alternatives_0_0");
					put(grammarAccess.getDefinitionAccess().getAlternatives_0_1(), "rule__Definition__Alternatives_0_1");
					put(grammarAccess.getDefinitionAccess().getAlternatives_0_3(), "rule__Definition__Alternatives_0_3");
					put(grammarAccess.getDefinitionAccess().getAlternatives_1_0(), "rule__Definition__Alternatives_1_0");
					put(grammarAccess.getDefinitionAccess().getAlternatives_1_1(), "rule__Definition__Alternatives_1_1");
					put(grammarAccess.getDefinitionAccess().getAlternatives_1_3(), "rule__Definition__Alternatives_1_3");
					put(grammarAccess.getDefinitionAccess().getAlternatives_2_0(), "rule__Definition__Alternatives_2_0");
					put(grammarAccess.getDefinitionAccess().getAlternatives_2_0_0(), "rule__Definition__Alternatives_2_0_0");
					put(grammarAccess.getDefinitionAccess().getAlternatives_2_0_1(), "rule__Definition__Alternatives_2_0_1");
					put(grammarAccess.getDefinitionAccess().getAlternatives_2_1(), "rule__Definition__Alternatives_2_1");
					put(grammarAccess.getDefinitionAccess().getAlternatives_2_4(), "rule__Definition__Alternatives_2_4");
					put(grammarAccess.getDefinitionAccess().getAlternatives_3_0(), "rule__Definition__Alternatives_3_0");
					put(grammarAccess.getDefinitionAccess().getAlternatives_3_3(), "rule__Definition__Alternatives_3_3");
					put(grammarAccess.getHelpinfoAccess().getAlternatives_0(), "rule__Helpinfo__Alternatives_0");
					...
					put(grammarAccess.getColumnTypeAccess().getAlternatives_1(), "rule__ColumnType__Alternatives_1");
					...
					put(grammarAccess.getFlowAccess().getAlternatives_0(), "rule__Flow__Alternatives_0");
					put(grammarAccess.getFlowAccess().getAlternatives_1(), "rule__Flow__Alternatives_1");
					put(grammarAccess.getFlowAccess().getAlternatives_2(), "rule__Flow__Alternatives_2");
					put(grammarAccess.getFlowAccess().getAlternatives_3(), "rule__Flow__Alternatives_3");
					put(grammarAccess.getFlowAccess().getAlternatives_4(), "rule__Flow__Alternatives_4");
					put(grammarAccess.getFlowAccess().getAlternatives_5(), "rule__Flow__Alternatives_5");
